...
class INET_API IContention
{
  ...
  public:
    ...
    // SWSH ADDED: alternative Contention mechanism
    virtual void startExtendedContention(int cw, simtime_t ifs, simtime_t eifs, simtime_t slotTime, ICallback *callback, int omega) = 0;
    // SWSH ADDED: function to cancel contentiion
    virtual void cancelContention() = 0;
    // SWSH ADDED: To get the backoff Slots
    virtual int getBackoffSlots() = 0;
    // addEnd
