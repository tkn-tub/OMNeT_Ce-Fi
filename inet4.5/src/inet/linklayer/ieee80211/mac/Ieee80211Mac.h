...
class INET_API Ieee80211Mac : public MacProtocolBase
{
  ...
  private:
    // SWSH ADDED: Signal to count the number of corrupted Frames (Collisions)
    simsignal_t corruptedFrameSignal;
    // addEnd
  protected:
    FcsMode fcsMode;
  ...
  protected:
    ...
    // virtual void configureRadioMode(physicallayer::IRadio::RadioMode radioMode); SWSH RMVD: Moved to be public
  ...
  public:
    ...
    // SWSH ADDED: Moved from protected to here to be used with other code
